function YouTubeClip() {
  ...
  var condition1 = validator.isInt(startsec.toString(), {min: 0, max:59 });
  var condition2 = validator.isInt(startmin.toString(), {min: 0, max:59 });
  var condition3 = validator.isInt(endsec.toString(), {min: 0, max:59 });
  var condition4 = validator.isInt(endmin.toString(), {min: 0, max:59 });
